...
public class SimpleWebServer extends NanoHTTPD {
	...
	public static final List<String> INDEX_FILE_NAMES = new ArrayList<String>() {
		...
		private static final long serialVersionUID = -8138302913818179327L;
	...
	private static final Map<String, String> MIME_TYPES = new HashMap<String, String>() {
		...
		private static final long serialVersionUID = -5139983145150652836L;
	...
	protected static void registerPluginForMimeType(final String[] indexFiles, final String mimeType, final WebServerPlugin plugin,
	...
	// private void addWwwRootDir(final File wwwroot) {
	...
	private Response respond(final Map<String, String> headers, final IHTTPSession session, String uri) {
		...
		if (f.isDirectory() && !uri.endsWith("/")) {
			uri += "/";
			Response res = createResponse(Response.Status.REDIRECT, NanoHTTPD.MIME_HTML, "<html><body>Redirected: <a href=\"" + uri + "\">" + uri
					+ "</a></body></html>");
		...
		if (f.isDirectory()) {
			...
			// none found, list the directory if
			// readable.
	...
	protected Response getInternalErrorResponse(final String s) {
		return createResponse(Response.Status.INTERNAL_ERROR, NanoHTTPD.MIME_PLAINTEXT, "INTERNAL ERRROR: " + s);
	}
	...
	private String getMimeTypeForFile(final String uri) {
