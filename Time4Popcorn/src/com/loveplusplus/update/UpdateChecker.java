...
public class UpdateChecker extends Fragment {
	...
	protected String sendPost(String urlStr) throws SocketTimeoutException {
	...
	private void parseJson(String json) {
		...
		try {
			...
			String updateMessage = getActivity().getString(
					R.string.download_and_install_the_updates_);

			int versionCode = mContext.getPackageManager().getPackageInfo(
					mContext.getPackageName(), 0).versionCode;

			Log.e("UPDATE", apkCode + ":APK NEW " + versionCode + ":MINE");
