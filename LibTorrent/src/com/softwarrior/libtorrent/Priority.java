...
public class Priority {
	...
	public static final int AS_PARTIAL_PIECES = 3;
	public static final int OVER_PARTIAL_PIECES = 4;
	public static final int LIKELY_OVER_PARTIAL_PIECES = 5;
	public static final int LIKELY_NORMAL = 6;
	public static final int MAXIMAL = 7;
}